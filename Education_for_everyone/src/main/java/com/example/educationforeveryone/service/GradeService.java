...
import com.example.educationforeveryone.models.Grade;
...
import com.example.educationforeveryone.repository.*;
...
public class GradeService {
    ...
    public void assignHomeworkToStudent(Long studentId, Long homeworkId, String username) {
        ...
        List<Long> groupIds = groupOfStudentsRepository.findGroupIdByStudentId(studentId);
        ...
        if (gradeRepository.findByStudent_IdAndHomework_Id(studentId, homeworkId).isPresent())
    ...
    public void assignScoreToStudent(Long studentId, Long homeworkId, Long score, String username) {
        ...
        Grade grade = gradeRepository.findByStudent_IdAndHomework_Id(studentId, homeworkId).orElseThrow(() -> new DoNotMatchException("Homework And Student Do Not Match"));
